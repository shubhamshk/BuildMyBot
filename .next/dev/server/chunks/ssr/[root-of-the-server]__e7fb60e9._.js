 ...
 */ async function generateWithFallback(provider, apiKey, prompt, generationType) {
    ...
    try {
        const result = await aiProvider.generate(prompt, apiKey, model);
        return result;
    } catch (error) {
        ...
        if (fallbackModel && error.message?.includes("model") || error.message?.includes("404")) {
            ...
            try {
                const result = await aiProvider.generate(prompt, apiKey, fallbackModel);
                return result;
            } catch (fallbackError) {
...
function CharacterResultPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$anisoul$2d$forge$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (character.generatedContent?.personality && character.generatedContent?.scenario && character.generatedContent?.initialMessage) {
            setSections({
                personality: {
                    loading: false,
                    error: null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7fb60e9._.js.map